...
<pre><code>externalInput(original:"<b>bold text</b>"
...
h4. Input Validation for Form Submissions
...
* <code>is_int</code> to expect an integer as accepted by "<code>StringToInt</code>":http://www.mozart-oz.org/home/doc/base/string.html#section.text.strings.
* <code>is_float</code> for floating point numbers as accepted by "<code>StringToFloat</code>":http://www.mozart-oz.org/home/doc/base/string.html#section.text.strings.
...
h4. Input Validation with public GET handlers
...
The <code>HandleSaid</code> function expects exactly exactly one GET parameter with its length constrained to 1 to 100. If the validation fails, an error message (including the problematic parameter) will be shown to the user.
...
Previous: [[The Session Object]] &nbsp;&nbsp; Next: [[Application Deployment]]
